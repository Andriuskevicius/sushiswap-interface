...
export default function Farm(): JSX.Element {
  ...
  return (
    <Container id="farm-page" className="grid h-full grid-cols-4 p-4 mx-auto md:py-8 lg:py-12 gap-9" maxWidth="7xl">
      <Head>
        <title>Farm | 123Swap</title>
        <meta key="description" name="description" content="Farm 123Swap" />
      </Head>
