  ...
  return (
    <>
      <div className="flex items-center justify-center mb-4 space-x-3">
        <div className="grid grid-cols-3 rounded p-3px h-[30px]">
          <NavLink
            activeClassName="font-bold text-high-emphesis border-dark-800"
            href={{
              pathname: '/swap',
              query: getQuery(input, output),
            }}
          >
            <a className="flex items-center justify-center px-8 text-base font-medium text-center text-secondary hover:text-high-emphesis border-r-2 border-bcolor">
              {i18n._(t`Swap`)}
            </a>
          </NavLink>
          <NavLink
          ...
          >
            <a className="flex items-center justify-center px-8 text-base font-medium text-center text-secondary hover:text-high-emphesis">
              {i18n._(t`Limit`)}
            </a>
          </NavLink>
          <NavLink
          ...
          >
            <a className="flex items-center justify-center px-8 text-base font-medium text-center text-secondary hover:text-high-emphesis border-l-2 border-bcolor">
              {i18n._(t`Liquidity`)}
            </a>
          </NavLink>
        </div>
      </div>
      <div className="flex justify-end items-center border-b border-bcolor pb-8">
        <div className="grid grid-flow-col gap-1">
          {isLimitOrder && (
            <div className="items-center h-full w-full cursor-pointer hover:bg-dark-800 px-3 py-1.5">
              <MyOrders />
            </div>
          )}
